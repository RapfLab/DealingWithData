...
DATARUN = "1mM_N2Purge_3"
FILE_PREFIX = "2OOA_1mM_N2Purge_26C_3_"
#FILE_PREFIX = DATARUN+"OOA_"
DATA_SUBFOLDER = "/"+DATARUN+"/"+DATARUN+"extracted" #where does the data live?
...
for entry in range(len(NUM_AVG)):
    print NUM_AVG[entry]
    AvgCorrPrefix = DATARUN+'Corr_Avg'+str(NUM_AVG[entry])
    AvgRadPrefix =DATARUN+'Rad_Avg'+str(NUM_AVG[entry])+'_Fpt'+str(R2FILTName)
